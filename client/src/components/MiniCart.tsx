          ...
          <>
            ...
            <div className="border-t border-stone-200 px-6 py-5">
              ...
              <a
                ...
                className="w-full flex items-center justify-center gap-2 bg-stone-900 text-white py-3.5 text-sm tracking-wide font-medium hover:bg-stone-800 transition-colors"
              >
