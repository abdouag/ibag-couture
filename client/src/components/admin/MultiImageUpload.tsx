          ...
          {allImages.map((url, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-all items-center justify-center gap-2 opacity-0 group-hover:opacity-100 hidden sm:flex">
                  {index > 0 && (
                    <button
                      type="button"
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-1.5 flex items-center justify-center gap-1.5 sm:hidden">
                  {index > 0 && (
                    <button
                      type="button"
                      onClick={() => moveImage(index, index - 1)}
                      className="p-1.5 bg-white/90 rounded-md text-stone-700 active:bg-stone-200"
                    >
                  ...
                  <button
                    type="button"
                    onClick={() => removeImage(url)}
                    className="p-1.5 bg-white/90 rounded-md text-red-600 active:bg-red-100"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
