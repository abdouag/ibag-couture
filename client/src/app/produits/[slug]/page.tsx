          ...
          <div className="bg-white rounded-sm p-8 md:p-12 lg:p-16 shadow-xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6 mb-10">
              {[
                ...
                <div key={measure.label} className="flex items-start gap-3 p-5 bg-stone-50 rounded-sm border border-stone-200 hover:border-amber-200 hover:bg-amber-50 transition-all duration-300">
                ...
                <table className="w-full text-sm md:text-base">
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={row.size} className="border-b border-stone-100 hover:bg-amber-50/50 transition-colors">
                        <td className="py-3 px-4">
                          <span className="inline-flex items-center justify-center w-9 h-9 bg-stone-900 text-white text-sm font-medium rounded-sm">{row.size}</span>
                        </td>
