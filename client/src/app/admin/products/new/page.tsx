  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.message || "Erreur lors de la creation du produit");
      }
    } catch (err) {
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-stone-500 mt-1 text-sm sm:text-base">
          Ajoutez une nouvelle creation a votre catalogue
        </p>
      </div>
      ...
      {success && (
        <div className="fixed top-4 right-4 z-50 animate-fadeIn">
          <div className="bg-green-600 text-white px-6 py-4 rounded-xl shadow-lg flex items-center gap-3">
            ...
            <div>
              <p className="font-medium">Produit cree avec succes!</p>
